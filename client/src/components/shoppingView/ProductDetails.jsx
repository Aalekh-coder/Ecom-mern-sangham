            ...
            <DialogContent className="grid grid-cols-2 gap-8 sm:p-12 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw]">
                ...
                <div className=''>
                    ...
                    <div className='flex items-center gap-2 mt-2'> <div className='flex items-center gap-0.5'>
                        <StarIcon className='w-5 g-5 fill-primary' />
                        <StarIcon className='w-5 g-5 fill-primary' />
                        <StarIcon className='w-5 g-5 fill-primary' />
                        <StarIcon className='w-5 g-5 fill-primary' />
                        <StarIcon className='w-5 g-5 fill-primary' />
                    ...
                    <div className='mt-5'>
                        <Button className="w-full mb-5" onClick={()=> handleAddtoCart(productDetails?._id)}>Add to Cart</Button>
                        <Separator />
                        ...
                        <div className="max-h-[300px] overflow-auto">
                            ...
                            <div className='grid gap-6'>
                                <div className='flex gap-4'>
                                    ...
                                    <div className="grid gap-1">
                                        ...
                                        <p className='text-muted-foreground'>this is the an awsome Product</p>
                                    </div>
                                </div>
                                <div className='flex gap-4'>
                                    <Avatar className="w-10 h-10 border">
                            ...
                            <div className="mt-6 flex gap-2">
                                <Input placeholder="Write a reviews..." />
